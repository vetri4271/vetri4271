...
Google Docs meets VS Code, with AI code explanation baked in.

`Docker` `Redis` `React` `Java` `Ollama`
...
### 🔥 Fire Detection AI
Real-time fire detection using a CNN pipeline.
...
### 🔐 FPGA AES
Adaptive encryption on a parallel hardware architecture.
